...
if __name__ == "__main__":
    ...
    if myif == 'spi':
        bmi08x_accel = Sensor('accel', CSB=BST.ShuttleBoardPin.COINES_MINI_SHUTTLE_PIN_2_1)
        bmi08x_gyro = Sensor('gyro', CSB=BST.ShuttleBoardPin.COINES_MINI_SHUTTLE_PIN_2_5)
    else:
    ...
    if myif == 'spi':
        ...
        BOARD.PinConfig(BST.ShuttleBoardPin.COINES_MINI_SHUTTLE_PIN_2_6, BST.EONOFF.ON,\
