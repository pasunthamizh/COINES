...
static void send_stream_settings(void)
{
    ...
    stream_config.cs_pin = COINES_MINI_SHUTTLE_PIN_2_1;
    ...
    stream_config.cs_pin = COINES_MINI_SHUTTLE_PIN_2_5;
...

{
    ...
    coines_start_stop_streaming(COINES_STREAMING_MODE_POLLING,
