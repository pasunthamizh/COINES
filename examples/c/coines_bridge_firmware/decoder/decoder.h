...
#define DECODER_MAX_PKT_SZ                              UINT8_C(64)
/*! Over head bytes in streaming response packet */
#define DECODER_RESPONSE_OVERHEAD                       UINT8_C(12)
/*! Actual data in streaming response */
#define DECODER_RESPONSE_PAYLOAD_SIZE                   (UINT8_C(DECODER_MAX_PKT_SZ - DECODER_RESPONSE_OVERHEAD))
...
typedef enum
{
    ...
    DECODER_EXTID_POLLSTREAM_COMMON = _DECODER_EXT_ID_BASE_ + 0x03, /*< decoder exit ID for communication in poll streaming */
    DECODER_EXTID_POLLSTREAM_OLD_READ = _DECODER_EXT_ID_BASE_ + 0x04, /*< decoder exit ID for read in poll streaming */
    DECODER_EXTID_POLLSTREAM_STARTSTOP = _DECODER_EXT_ID_BASE_ + 0x06, /*< decoder exit ID for start and stop in poll stream */
    DECODER_EXTID_FIFOSTREAM_READ = _DECODER_EXT_ID_BASE_ + 0x07, /*< decoder exit ID for fifo stream read */
    DECODER_EXTID_FIFOSTREAM_STARTSTOP = _DECODER_EXT_ID_BASE_ + 0x08, /*< decoder exit ID for start and stop in fifo stream */
    DECODER_EXTID_INTSTREAM_OLD_READ = _DECODER_EXT_ID_BASE_ + 0x09, /*< decoder exit ID for read in interrupt streaming */
    DECODER_EXTID_INTSTREAM_STARTSTOP = _DECODER_EXT_ID_BASE_ + 0x0A, /*< decoder exit ID for start and stop in interrupt streaming */
...
//extern bool int_pin_usage_native_emulated[];
/**********************************************************************************/
