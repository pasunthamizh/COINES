...
#define NICLA_I2C_SDA_PIN        NRF_GPIO_PIN_MAP(0, 15)
#define NICLA_I2C_SCL_PIN        NRF_GPIO_PIN_MAP(0, 16)
...
/* Nicla I2C instance */
static const nrfx_twim_t nicla_i2c_instance = NRFX_TWIM_INSTANCE(TWIM0_INSTANCE);
